...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Note Editor - Capture Your Thoughts">
                <meta
                    name="description"
                    content="Organize your thoughts, ideas and knowledge with our powerful note editor featuring AI-powered summarization and tagging."
                />
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">Welcome to Note Editor</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                Your personal space for capturing ideas, thoughts, and knowledge.
                                <br />
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                    ...
                                    <span>Create and organize notes with tags</span>
                                </li>
